            ...
            <AnimatePresence>
                ...
                >
                    <div className="flex flex-col gap-1.5">
                        <p className="text-stone-900 text-xl font-semibold tracking-wide dark:text-background-primary">Forgot Password</p>
                        <p className="text-neutral-500 text-sm dark:text-neutral-400">Enter your email address and we'll send you a link to reset your password.</p>
                    </div>
                    <AnimatePresence>
                        {isError &&
                            <motion.div
