@props(['title' => 'Email Notification'])
...
<head>
  ...
  <!-- Google Fonts (partially supported on some email clients like Apple Mail) -->
...
<body style="margin: 0; padding: 0; background-color: #F1F6FF;">
